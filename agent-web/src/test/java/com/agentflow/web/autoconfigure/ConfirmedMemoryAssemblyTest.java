...
class ConfirmedMemoryAssemblyTest {
    @Test void registersMemoryServiceAndControllerWithExplicitRepository() {
        new ApplicationContextRunner().withConfiguration(AutoConfigurations.of(com.agentflow.autoconfigure.AgentRuntimeAutoConfiguration.class, com.agentflow.tool.ToolPolicyAutoConfiguration.class, AgentWebAutoConfiguration.class))
